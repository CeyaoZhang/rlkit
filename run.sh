...
nohup python -u launch_experiment.py ./configs/cheetah-vel.json -alg=TD3 --gpu_id=0 --task_id 60 --srb > cheetah-vel_td3_id60_srb.log 2>&1 &
nohup python -u launch_experiment.py ./configs/cheetah-vel.json -alg=TD3 --gpu_id=1 --task_id 61 --srb > cheetah-vel_td3_id61_srb.log 2>&1 &


# python -m viskit.frontend /data/px/ceyaozhang/MyCodes/rlkit/output ## visulize the result